...
//		deque.removeFirst();
		...
		//Printing removeFirst which ideally should remove "Hello" because it was added first
		//However, it's printing "World". Therefore the implementation of "deque.addFirst" or
		//deque.removeFirst could be incorrect. TODO: Work on this!
		System.out.println(deque.removeFirst());
		
		//Printing removeLast which ideally should remove "World" because it was added last. 
		//this is correct 
